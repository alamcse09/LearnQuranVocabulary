...
import com.alamashraful.qv.MainActivity;
import com.alamashraful.qv.R;
...
public class TanzilReader {
	...
	public Chapter[] readXml(String resourcePath) {
		...
		try {
			...
			InputStream stream = MainActivity.context.getResources().openRawResource(R.raw.quran_uthmani);
